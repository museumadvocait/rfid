...
<html>
  <head>
    <title>CONTENT AGGREGATION FROM OBJECT #1 DEMO</title>
    <META http-equiv="refresh" content="1;URL=simulation_aggregation_demo_ipad1.php">
  ...
  <body bgcolor="#ffffff">
    <center>
      <table border='1'>
        <?php
          if($flag==-1){
//            echo "<tr><td colspan='2'><font size='4'>SWIPE ANY TAG ON OBJECT#1 TO START THE CONTENT AGGREGATION FROM OBJECT #1 DEMO</td></tr>";
          }
          else{
