...
<html>
  <head>
    ...
    <META http-equiv="refresh" content="2;URL=update_aggregation_demo.php">
  </head>
  <body bgcolor="#ffffff">
    <center>
        <?php        
            ...
            if($flag==0){
              ...
              while ($row = mysqli_fetch_row($result)) {
                ...
                while ($row2 = mysqli_fetch_row($result2)) {              
                  ...
                  $result3 = mysqli_query($con,"SELECT visitor FROM content_arduino1 WHERE value='".$row2[1]."'");                  
                  $row3 = mysqli_fetch_row($result3);
                  if(strstr($row3[0],'Caitlyn')){$count11++;$count1=$count11+$count12;}
              ...
              while ($row = mysqli_fetch_row($result)) {
                ...
                while ($row2 = mysqli_fetch_row($result2)) {              
                  ...
                  $result3 = mysqli_query($con,"SELECT visitor FROM content_arduino1 WHERE value='".$row2[1]."'");                  
                  $row3 = mysqli_fetch_row($result3);
                  if(strstr($row3[0],'Caitlyn')){$count12++;$count1=$count11+$count12;}
/*
...
*/                  
              ...
              if($flag_count==1){
                      ...
                      echo "<tr><td align='center'>Caitlyn</td><td align='center'>1</td><td align='center'>".date("D M j G:i:s",time())."</td>";
